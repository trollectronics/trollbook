...
$EndDescr
$Comp
L peripheral-board-rescue:10056847-XY1LF-RESCUE-peripheral-board CONN9001
U 1 1 581F82EF
P 5550 2150
...
DETECT
$Comp
L peripheral-board-rescue:C-RESCUE-peripheral-board C9001
U 1 1 58246CCC
P 4400 2050
F 0 "C9001" H 4000 2100 50  0000 L CNN
F 1 "10u" H 4050 2000 50  0000 L CNN
F 2 "Capacitors_SMD:C_1206" H 4438 1900 50  0001 C CNN
F 3 "" H 4400 2050 50  0000 C CNN
	1    4400 2050
	1    0    0    -1  
$EndComp
$Comp
L peripheral-board-rescue:+3V3-RESCUE-peripheral-board #PWR097
U 1 1 58A3C2FE
P 4250 1900
F 0 "#PWR097" H -300 800 50  0001 C CNN
...
$EndComp
$Comp
L peripheral-board-rescue:GND-RESCUE-peripheral-board #PWR098
U 1 1 58A3C347
P 4250 2200
F 0 "#PWR098" H -700 1000 50  0001 C CNN
...
$EndComp
$Comp
L peripheral-board-rescue:GND-RESCUE-peripheral-board #PWR099
U 1 1 58A3DB73
P 6650 1950
F 0 "#PWR099" H 1700 750 50  0001 C CNN
...
$EndComp
$Comp
L peripheral-board-rescue:GND-RESCUE-peripheral-board #PWR0100
U 1 1 58A3DB88
P 6650 2250
F 0 "#PWR0100" H 1700 1050 50  0001 C CNN
...
$Comp
L peripheral-board-rescue:R-RESCUE-peripheral-board R9001
U 1 1 58A5EC2B
P 4550 1550
...
$EndComp
$Comp
L peripheral-board-rescue:+3V3-RESCUE-peripheral-board #PWR0101
U 1 1 58A5EC6F
P 4550 1400
F 0 "#PWR0101" H -400 -200 50  0001 C CNN
